...
<script>
  (function() {
    var cx = '016656741306535874023:yzyactsyie0';
...
$confirmed = 0;
 ...
 // now we insert it into the database
  ...
  $subject = "International Journal of Mining, Materials, and Metallurgical Engineering (IJMMME)"; 
  $message = "Thank you for signing up to receive alerts for IJMMME - International Journal of Mining, Materials, and Metallurgical Engineering.
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <p class="body">Thank you for subscribing to IJMMME - International Journal of Mining, Materials, and Metallurgical Engineering. A confirmation email has been sent to your email. Please click on the confirmation link available in the email to confirm your subscription.</p>
